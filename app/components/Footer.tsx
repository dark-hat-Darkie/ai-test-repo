        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-sm text-gray-400 leading-relaxed max-w-xs">
              AI-powered development automation that streamlines your workflow.
              From issue to pull request, X-Force handles the heavy lifting so
          ...
          {/* Column 2: Product */}
          <div>
            <h3 className="text-sm font-semibold text-gradient mb-4">Product</h3>
          ...
          {/* Column 3: Company */}
          <div>
            <h3 className="text-sm font-semibold text-gradient mb-4">Company</h3>
            <ul className="space-y-3">
              <li>
                <Link
                  href="/about"
